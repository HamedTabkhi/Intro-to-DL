...
# Dropout layers are set with a rate of 0.3, 
# which means approximately 30% of the activations will be randomly set to zero during training
# Helping prevent overfitting by providing a form of regularization.
class VGG11(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.features = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(0.3),  # Added dropout here
        ...
        self.classifier = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(),  # You can specify the dropout rate here, e.g., nn.Dropout(0.5)
            nn.Linear(1024, 256),
            nn.ReLU(),
            nn.Dropout(),  # Similarly, specify the dropout rate if different from the default (0.5)
